                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('presensi.store') }}" method="post">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                <td>JAM Masuk</td>
                                <td><input type="date" name="jam_masuk" id="jam_masuk" class="@error('jam_masuk') is-invalid @enderror" required></td>
                                @error('jam_masuk')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </tr>
                            ...
                            <tr>
                                <td>Lokasi Masuk</td>
                                <td><input type="text" name="lokasi_masuk" id="lokasi_masuk" class="@error('lokasi_masuk') is-invalid @enderror" required></td>
                                @error('lokasi_masuk')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </tr>
